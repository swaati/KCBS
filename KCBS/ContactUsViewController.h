    ...
    @property(nonatomic,strong) UIImageView *imgview_contactus;
    @property(nonatomic,strong)UILabel *contactusLabel;
    @property(nonatomic,strong)UILabel *head_label;
    @property(nonatomic,strong)UILabel *mng_label;
    ...
    @property(nonatomic,strong)UILabel *branch_sublbl;
    @end
