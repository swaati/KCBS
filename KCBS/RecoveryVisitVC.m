                        ...
                        @synthesize passedaddress_string;
                                ...
                                {
                                    [super viewDidLoad];
                                    self.dataArray = [[NSMutableArray alloc] initWithObjects:@"Tiger",nil];
                        ...
                        //            loniadrs_lbl1.text=@" ";
                                ...
                                //    ///////
                                  ...
                                  [detailoverview_view addSubview:principle_lbl1];
                                    ...
                                    recoverytable_view=[[UIView alloc]initWithFrame:CGRectMake(0,0, 320,400)];
                                    recoverytable_view.backgroundColor=[UIColor yellowColor];
                                    recovery_tv =[[UITableView alloc] initWithFrame:CGRectMake(0,131,320,300) style:UITableViewStylePlain];
                                    [recovery_tv setSeparatorStyle: UITableViewCellSeparatorStyleSingleLine];
                                    recovery_tv.backgroundColor=[UIColor orangeColor];
